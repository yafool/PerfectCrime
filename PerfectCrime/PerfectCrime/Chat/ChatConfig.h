...
#define VIEW_HEIGHT     SCREEN_HEIGHT - kTopInset //去掉状态栏和navbar后，view区域高度
/// View 圆角
...
#define ChatCache_Path   [NSHomeDirectory() stringByAppendingString:[NSString stringWithFormat:@"/Library/Caches/ChatSource/%@",[[SettingsManager sharedSettingsManager]userId]]]
