...
{
    if (!_animationView) {
        _animationView = [[UIImageView alloc]initWithFrame:CGRectMake((ViewFrame_bounds_width - 120)*0.5, (ViewFrame_bounds_height - 120)*0.5, 120, 120)];
    }
...
{
    if (!_cutdownLabel) {
        _cutdownLabel = [[UILabel alloc]initWithFrame:CGRectMake((ViewFrame_bounds_width - 120)*0.5, (ViewFrame_bounds_height - 120)*0.5, 120, 120)];
...
- (void)failRecord{
    NSLog(@"Mp3RecorderDelegate::failRecord");
}

- (void)beginConvert{
    NSLog(@"Mp3RecorderDelegate::beginConvert");
}
