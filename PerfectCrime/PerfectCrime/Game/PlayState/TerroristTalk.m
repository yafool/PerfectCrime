...
static NSString *Wate2Do          =@"杀谁";

@interface TerroristTalk ()
//倒计时
...
@implementation TerroristTalk
-(void)OnPlaying{
    GameConfig * config = [GameInfoManager sharedGameInfoManager].gameConfig;
    self.countdown = config.murderNightSpeakTime;
    
    [[GameHandler shareInstance]terroristTalk];
